...
// Skills data
const skills =[
  { name: "Python", value: 90, color: "from-yellow-200 to-green-400" },
  { name: "FastAPI", value: 85, color: "from-teal-200 to-cyan-400" },
  { name: "SQL", value: 85, color: "from-blue-200 to-blue-500" },
  { name: "PostgreSQL", value: 80, color: "from-indigo-200 to-indigo-400" },
  { name: "REST API Design", value: 90, color: "from-green-200 to-emerald-400" },
  { name: "Pydantic", value: 80, color: "from-purple-200 to-pink-400" },
  { name: "Git", value: 75, color: "from-red-200 to-orange-400" },
  { name: "Postman", value: 85, color: "from-orange-200 to-yellow-400" },
  { name: "Manual & Functional Testing", value: 75, color: "from-slate-200 to-slate-400" },
  { name: "HTML", value: 80, color: "from-orange-200 to-yellow-400" },       
  { name: "Next.js", value: 50, color: "from-purple-100 to-purple-300" },     
  { name: "FastAPI Testing", value: 70, color: "from-rose-200 to-pink-400" }
]
