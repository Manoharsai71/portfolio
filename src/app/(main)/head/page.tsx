...
export default function Head() {
  const descriptionText =
    "Passionate about building efficient and scalable backend systems. I specialize in modern Python development with FastAPI and PostgreSQL."

  const words = [
  { text: "Backend", className: "text-white" },
  { text: "Developer", className: "text-white" },
  { text: "|", className: "text-white" },
  { text: "FastAPI", className: "text-teal-400 dark:text-teal-400" },
...
></span>
            ...
            <div className="flex flex-col items-left  justify-center space-y-6">
              ...
              >
                ...
                <h1 className="text-3xl sm:text-3xl md:text-6xl lg:text-6xl lg:text-6xl leading-none mt-4 font-bold">
                  I'm <span className="text-orange-400">Manohar</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Button
                    ...
                    onClick={() => window.open("tel:+919849028484")}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => window.open("images/manohar resume.pdf", "_blank")}
                  >
  ...
  {/* Social Media Icons */}
  {[
    { icon: Linkedin, url: "https://www.linkedin.com/in/manohar-sai-ambati-1812b6364/", color: "text-blue-500 hover:text-blue-700" },
    { icon: Mail, url: "mailto:manoharsaiambati2002@gmail.com", color: "text-red-500 hover:text-red-700" },
    { icon: Github, url: "https://github.com/manoharsai71", color: "text-gray-200 hover:text-gray-700" },
    { icon: Instagram, url: "https://www.instagram.com/manohar_minnu", color: "text-pink-500 hover:text-pink-700" },
    { icon: Twitter, url: "https://twitter.com/manohar_minnu", color: "text-green-500 hover:text-green-700" },
  ].map((social, index) => (
    <Button
      key={index}
    ...
    >
      <social.icon className={`w-6 h-6 ${social.color}`} />
            ...
            {/* Product Image */}
            <div className="relative flex justify-center md:justify-end my-20 translate-x-[0px] md:translate-x-[-30px] lg:translate-x-[-90px]">
              <img
              src="./images/manohar1.png"
              alt="Manohar"
